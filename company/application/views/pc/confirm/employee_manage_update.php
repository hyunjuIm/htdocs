	...
	<div class="container" style="width:80%;margin: 0 auto">
				...
				<tr>
					...
					<td style="vertical-align: middle !important;">
						...
						<div style="display: flex;">
							...
							<div class="btn-white" onclick="downloadBasicSheet('customer', '회사명_사업장_날짜_직원입력 양식.xlsx')">
								양식다운로드
							</div>
						</div>
					</td>
		...
		<div class="row" style="display: block;margin-top: 5rem;">
			<div style="float:right;">
				<div class="btn-light-grey-square" onclick="saveEmployeeManageData()">글수정</div>
...
<script>
	...
	$(document).ready(function () {
		...
		instance.post('C0304', mId).then(res => {
	...
	function saveEmployeeManageData() {
		...
		if (confirm("저장하시겠습니까?") == true) {
			instance.post('C0307', saveItems).then(res => {
				if (res.data != 'FAILED') {
					uploadFile(res.data);
				}
	...
	function uploadFile(id) {
		...
		if ($('#filename').html() == '&nbsp;' || $('#filename').text() == '') {
			var sendItems = new Object();
			sendItems.hlpId = mId.hlpId;
