...
<div id="pc_customer_login" style="display: none">
	<?php
	require('pc_customer_login.php');
	?>
</div>

<div id="m_customer_login" style="display: none">
	<?php
	require('m_customer_login.php');
	?>
</div>
...
<script>
	...
	var onresize = function () {
		...
		if (width <= 400) {
			...
			$("#pc_customer_login").hide();
			$("#m_customer_login").show();
		} else {
			console.log('데스크탑 화면 입니다.');
			$("#pc_customer_login").show();
			$("#m_customer_login").hide();
		}
	};
